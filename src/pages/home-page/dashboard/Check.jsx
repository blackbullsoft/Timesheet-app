...
const events = {
  "2025-03-06": [{ name: "Alex Borg", location: "Mirzapur",backgroundColor:'#01417B',day:false,timing:"6:00 AM - 4:00 PM, 10hours",isFullDay:false },
  { name: "Alex Borg", location: "Nodia",backgroundColor:'#DDDDDD',day:true,timing:"6:00 AM - 4:00 PM, 10hours",isFullDay:true },
  { name: "Alex Borg", location: "Delhi",backgroundColor:"#0085FE" ,day:true,timing:"6:00 AM - 4:00 PM, 10hours",isFullDay:false}
  ],
  "2025-02-18": [{ name: "Alex Borg", location: "RS2 Mosta ",backgroundColor:"#0085FE",day:true ,timing:"6:00 AM - 4:00 PM, 10hours",isFullDay:false}],
  "2024-12-18": [{ name: "Alex Borg", location: "RS2 Mosta ",backgroundColor:"#0085FE",day:true ,timing:"6:00 AM - 4:00 PM, 10hours",isFullDay:false}]
};
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Pressable onPress={() => setMenu(0)}>
          <Text style={[styles.headerText, menu == 0 && styles.selectedText]}>My schedule</Text>
        </Pressable>
        <Pressable onPress={() => setMenu(1)}>
          <Text style={[styles.headerText, menu == 1 && styles.selectedText]}>Full schedule</Text>
        </Pressable>
        <Pressable onPress={() => setMenu(2)}>
          <Text style={[styles.headerText, menu == 2 && styles.selectedText]}>Available</Text>
        </Pressable>
            ...
            return (
              ...
              >
                <Text
                  style={[
                    styles.dateText,
                    isSelected && { color: "#007BFF", fontSize: 30, fontWeight: 600 },
                  ]}
                >
                  {item.format("D")}
                </Text>
        ...
        renderItem={({ item }) => {
          ...
          return (
            <View style={styles.scheduleItem}>
              <View>
                <Text style={[styles.scheduleDate, selectedDate.isSame(item, "day") && { color: "#0085FE", fontSize: 22, fontWeight: 600 }]}>{item.format("D MMM")}</Text>
              ...
              {eventList.length > 0 ? (
                <View style={{ width: '72%' }}>
                  {
                    eventList.map((event, index) => (                      
                      <View key={index} style={[styles.eventBox,{backgroundColor:event?.backgroundColor}]}>                        
                ...
                <Text style={[styles.scheduleText, selectedDate.isSame(item, "day") && styles.selectedMsg]}>
