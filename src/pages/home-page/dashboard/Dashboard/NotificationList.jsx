...
const getGreeting = () => {
  ...
  const Card=({item})=>{
    ...
    return(
        <Pressable style={styles.box1} onPress={()=>navigation.navigate("Event",{timesheetId:item?.timesheet_id})}>
        <Image source={Shift} />
...
export default function Home() {
    ...
    const { data:notifications,loading:notificationLoading } = useSelector((state) => state.notifications);
    ...
    return (
        ...
        <LoadingAnimation />
                ...
                {
        notificationLoading? <View style={{width:"100%",height:"100%"}}>

        <LoadingAnimation />
        </View>:
           <View >
            {
                notifications?.length==0? <View style={styles.box}>
                <Image source={Gift} />
