...
const Card=(item)=>{
    ...
    return (
      <Pressable style={styles.card}  onPress={() => navigation.navigate("Message")} >
...
<Text style={styles.value}>{item.item?.reply}: {item?.item?.message}</Text>
        </View>
...
// dispatch(fetchCoworkersList())
  ...
  return (
    ...
    <TextInput placeholder='Quickly find a conversation...' style={styles.inputStyle} placeholderTextColor="#555555" />
      </View>
      {
        loading?
