...
export default function Event({route}) {
  ...
  console.log('Event data', data, route?.params?.timesheetId);
  return (
    <View>
      {loading ? (
        <>
          ...
          {data ? (
            <ScrollView>
              <View style={styles.box}>
                ...
                <Text style={styles.title}>{data?.events}</Text>
              ...
              <Pressable
                ...
                <View style={styles.left}>
                  ...
                  />
                  <Text style={styles.leftTitle}>Employee:</Text>
              ...
              <Pressable
                ...
                <View style={styles.left}>
                  ...
                  <Text style={styles.leftTitle}>Location:</Text>
              ...
              <View style={[styles.card, {alignItems: 'flex-start'}]}>
                <View style={[styles.left, {alignItems: 'flex-start'}]}>
                  ...
                  <View>
                    <Text style={styles.leftTitle}>Repeat</Text>
