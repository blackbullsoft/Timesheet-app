import { View, Text, StyleSheet, ScrollView, Image, ImageBackground, TextInput, TouchableOpacity,Linking } from 'react-native'
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.containerB}>
        ...
        <TouchableOpacity style={styles.box1} onPress={handleMessagePress}>
          <Image source={Message} style={{width:28,height:24}} />
          <Text style={styles.iconText}>Message</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.box1} onPress={handleEmailPress}>
        ...
        <View>
               ...
               <View style={[styles.contactStyles,{width:'90%',margin:'auto'}]}>
                <View style={[styles.inputBox1,styles.input1]}>
                  ...
                  <Text style={[styles.inputFeild,{padding:12}]}>{data?.mobile?.slice(0,3)} </Text>
                </View>
                <View style={[styles.inputBox1,styles.input2]}>
                  <Text tyle={styles.lable}>
                  Phone number
                  </Text>
                  <Text style={[styles.inputFeild,{padding:12}]}>{data?.mobile?.slice(3)} </Text>
