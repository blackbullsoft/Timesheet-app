    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Pressable onPress={() => setMyShedule(true)}>
          <Text style={[styles.headerText, myshedule && styles.selectedText]}>
            My schedule
          </Text>
        </Pressable>
        {user?.role == '1' && (
          <Pressable onPress={() => setMyShedule(false)}>
            <Text
              style={[styles.headerText, !myshedule && styles.selectedText]}>
              Full schedules
            </Text>
          </Pressable>
        )}
        ...
        <>
          <View style={styles.header1}>
            <View style={{display: 'flex', flexDirection: 'row', gap: 4}}>
              <Text>
                {moment(selectedDate).subtract(2, 'days').format('DD')} -{' '}
          ...
          <View style={styles.modalView}>
            ...
            <View style={styles.btnContainer}>
              ...
              <View style={styles.btn2}>
                <Text style={styles.btnText2}>Apply Filters</Text>
              </View>
            </View>
          </View>
        </View>
