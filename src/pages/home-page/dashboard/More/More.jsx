...
const shareApp = async () => {
    try {
        await Share.open({
            message: "Timesheet is a communication and shift scheduling tool for teams like yours. I'm using Sling and love it! Try it out - ",
...
useEffect(() => {
  ...
  return (
    <ScrollView>
        <Pressable style={styles.card}  onPress={() => navigation.navigate("Dashboard", { screen: "Profile" })}>
            <View>
        ...
        <Pressable style={styles.card} onPress={()=>navigation.navigate("AnnouncementList")}>
        ...
        <Pressable style={styles.card} onPress={()=>navigation.navigate("Setting")}>
            <View style={styles.imageCard}>
        ...
        <Pressable style={styles.card1} onPress={()=>navigation.navigate("Coworkers")}>
            <View style={styles.imageCard}>
        ...
        <Pressable style={styles.card1} onPress={()=>navigation.navigate("Feedback")} >
            <View style={styles.imageCard}>
        ...
        <Pressable style={styles.card1} onPress={()=>navigation.navigate("HelpAndSupport")}>
            <View style={styles.imageCard}>
