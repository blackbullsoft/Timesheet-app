  ...
  return (
    <View>
      <View style={styles.container}>
        ...
        Please take a moment to leave a comment. It would be  really helpful to us.
        </Text>
        <Text style={styles.heading}>
        Like using Timesheet ?
        </Text>
...
<Icon
        ...
        <TextInput style={styles.inputFeild} placeholder='Your Opinion....' placeholderTextColor="#555555"  textAlignVertical="top"
        value={feedback}
