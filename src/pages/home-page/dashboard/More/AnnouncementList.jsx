...
const Card=(item)=>{
    ...
    return (
        <Pressable style={styles.card} onPress={()=>navigation.navigate("Announcement",{
            title:item?.item?.events,
            des:item?.item?.description
        })}>
        <View style={styles.left}>
            <Text style={styles.lable}>{item?.item?.events
}</Text>
            <Text style={styles.value}>{item?.item?.description
            }</Text>
        </View>
