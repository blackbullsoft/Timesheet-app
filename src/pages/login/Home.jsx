...
const data = [
  {
    heading: 'Shifts',
    subHeading:
      'Manage your schedule, time off, availability and shift trade requests.',
    img: Shift,
  },
  {
    heading: 'Dashboard',
    subHeading:
      'Get notified about what needs your attention and take immediate action.',
    img: Dashboard,
  },
  {
    heading: 'Timeclock',
    subHeading:
      'Easily clock in and out from your phone for accurate time tracking and seamless shift management.',
    img: TimeClock,
  },
  {
    heading: 'Messages',
    subHeading:
      'Chat with coworkers either in groups or in private conversations.',
    img: Message,
  },
  {
    heading: 'Tasks',
    subHeading:
      'Assign tasks or create your personalized to-do list to stay organized and boost productivity.',
    img: Tasks,
  },
  {
    heading: 'Newsfeed',
            ...
            <ImageBackground
              ...
              <View style={styles.bottomContainer}>
                ...
                <Pressable
                  ...
                  onPress={() => handleNavigateToLogin(true)}>
                  <Text style={styles.btnText1}>Login Now</Text>
                </Pressable>
                <Pressable
                  style={[styles.btnLogin, styles.btnNew]}
                  onPress={() => handleNavigateToLogin(false)}>
